/**
 * Taken from Matt Deslauriers' canvas-sketch
 * https://github.com/mattdesl/canvas-sketch/blob/2e5ccd3bd7d49baf894195adf43cfab1d8daf046/examples/util/penplot.js
 */
...
export default function exportPolylines(polylines, opt = {}) {
  ...
  const lineWidth =
    typeof opt.lineWidth === 'number' ? opt.lineWidth : DEFAULT_SVG_LINE_WIDTH;
